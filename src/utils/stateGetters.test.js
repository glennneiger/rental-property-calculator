...
// TODO: fix tests, see https://github.com/gregdardis/rental-property-calculator/issues/157
// import {
//   getAfterRepairValue,
...
//     it('returns proper value', () => {
//       expect(getAfterRepairValue(state))
//         .to
//         .equal(AFTER_REPAIR_VALUE);
//     });
//     it('returns 0 if after repair value is undefined', () => {
//       state.calculator[TITLE_INITIAL_PURCHASE]
...
//     it('returns proper value', () => {
//       expect(getAnnualPropertyValueGrowth(state))
//         .to
...
//     it('returns proper value', () => {
//       expect(getAnnualIncomeGrowth(state))
//         .to
...
//     it('returns proper value', () => {
//       expect(getAmortizationPeriod(state))
//         .to
...
//     it('returns proper value', () => {
//       expect(getOtherInitialCosts(state))
//         .to
...
//     });
//   });
//   describe('getInitialPurchasePrice', () => {
//     it('returns proper value', () => {
//       expect(getInitialPurchasePrice(state))
//         .to
...
//     it('returns proper value', () => {
//       expect(getMonthlyMortgage(state))
//         .to
