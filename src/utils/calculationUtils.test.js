...
import {
  ...
  //   getCompoundedValue,
  //   makeValidGrowthRate,
  formatServerCalculationForClient,
  formatClientCalculationForServer
...
const serverCalc = Object.freeze({
  'General Info': {
    inputs: { cityInput: 'Edmonton' },
    notes: 'some notes'
  }
});
const clientCalc = Object.freeze({
  'General Info': {
    inputs: { cityInput: 'Edmonton' },
    notes: {
      text: 'some notes',
...
describe('utils/calculationUtils', () => {
  ...
  //   });
  // });
  describe('formatServerCalculationForClient', () => {
    it('converts server format to client format', () => {
      expect(formatServerCalculationForClient(serverCalc))
        .to.deep.equal(clientCalc);
    });
  });
  describe('formatClientCalculationForServer', () => {
    it('converts server format to client format', () => {
      expect(formatClientCalculationForServer(clientCalc))
        .to.deep.equal(serverCalc);
    });
  });
});